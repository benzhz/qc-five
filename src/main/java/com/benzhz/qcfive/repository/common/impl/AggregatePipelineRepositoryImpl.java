...
import com.benzhz.qcfive.repository.common.AggregatePipelineRepository;
...
@Slf4j
@Service
public class AggregatePipelineRepositoryImpl implements AggregatePipelineRepository {
     ...
     */
    @Override
    public Object aggregateGroupMatch(String collectionName, AggregationOperation match, AggregationOperation group) {
     ...
     */
    @Override
    public Object aggregateGroupSort(String collectionName, AggregationOperation group, AggregationOperation sort) {
     ...
     */
    @Override
    public Object aggregateGroupLimit(String collectionName, AggregationOperation group, AggregationOperation limit) {
...
//        AggregationOperation limit = Aggregation.limit(5L);
     ...
     */
    @Override
    public Object aggregateGroupSkip(String collectionName, AggregationOperation group, AggregationOperation limit) {
...
//        AggregationOperation limit = Aggregation.skip(2L);
     ...
     */
    @Override
    public Object aggregateGroupProject(String collectionName, AggregationOperation group, AggregationOperation project) {
...
//        AggregationOperation project = Aggregation.project("maxSalary");
     ...
     */
    @Override
    public Object aggregateProjectUnwind(String collectionName, AggregationOperation project, AggregationOperation unwind) {
