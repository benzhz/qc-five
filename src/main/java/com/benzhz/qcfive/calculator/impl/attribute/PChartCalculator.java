...
import com.benzhz.qcfive.calculator.bo.attribute.PChartBo;
import org.springframework.stereotype.Service;

import java.util.List;

import static com.benzhz.qcfive.common.constants.SPCChartConstants.CHART_P;
 ...
 */
@Service(CHART_P)
public class PChartCalculator extends AbstractAttributeCalculator {

    @Override
    public SPCControlCharBo calculate(List<AttributeBo> sampleData) {
        return new SPCControlCharBo(new PChartBo(sampleData));
    }
}
